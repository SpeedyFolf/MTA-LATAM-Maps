...
addEventHandler("onResourceStart",resourceRoot,
	function ()
		...
		-- South
		carshade09 = createObject(3458,-2281.69,1876.94,29,0,0,0)
		carshade10 = createObject(3458,-2281.69,1871.82,29,0,0,0)
		carshade11 = createObject(3458,-2321.69,1876.94,29,0,0,0)
		carshade12 = createObject(3458,-2321.69,1871.82,29,0,0,0)
		carshade13 = createObject(3458,-2354.29,1876.94,29,0,0,0)
		carshade14 = createObject(3458,-2354.29,1871.82,29,0,0,0)
		carshade15 = createObject(3458,-2394.29,1876.94,29,0,0,0)
		carshade16 = createObject(3458,-2394.29,1871.82,29,0,0,0)
		createGhosts()
	end
)
...
addEventHandler("onRaceStateChanging",root,
	function (newstate,oldstate)
		if newstate == "Running" and oldstate == "GridCountdown" then
			...
			-- South
			setTimer(destroyElement,20000,1,carshade09)
			setTimer(destroyElement,20000,1,carshade10)
			setTimer(destroyElement,20000,1,carshade11)
			setTimer(destroyElement,20000,1,carshade12)
			setTimer(destroyElement,20000,1,carshade13)
			setTimer(destroyElement,20000,1,carshade14)
			setTimer(destroyElement,20000,1,carshade15)
			setTimer(destroyElement,20000,1,carshade16)
