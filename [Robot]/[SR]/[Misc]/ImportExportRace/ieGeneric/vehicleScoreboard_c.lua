g_vehicleStartTime = 0-- Screen stuff
screenX, screenY = guiGetScreenSize()
screenAspect = math.floor((screenX / screenY)*10)/10

g_vehicleStartTime = 0
...
function drawStats()
	...
	dxDrawText(g_vehicleStartTime == 0 and "" or convertToRaceTime(getTickCount() - g_vehicleStartTime), 	screenX*(st_offsets[1]+0.03), 	textY, 	screenX*(st_offsets[1]+0.1675), 	screenY, 	tocolor(127, 255, 225, statsAlpha), st_offsets[5]*4.8, 	"default-bold", "right")
end
...
addEventHandler("vehicleUnfreeze", resourceRoot, function() 
	g_vehicleStartTime = getTickCount() -- stats
end)
