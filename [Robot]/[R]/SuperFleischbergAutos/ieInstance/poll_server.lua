...
function assemblePollOptions() 
	...
	elseif (time.year == 124 and time.month == 10 and time.monthday == 2 and time.hour > 9) then
		...
		nominateItem(212)
	elseif (time.year == 125 and time.month == 3 and time.monthday == 6 and time.hour > 9) then
		iprint("[FleischBerg Autos] Secret S.' Birthday Party that he himself can't really attend :)")
		nominateItem(212)
	end
