...
local heights = {
  ...
  [trailerstairs] = 3.11,
  [boxvillemission] = 2.55,
  [farmtrailer] = 1.33,
  [streetcleantrailer] = 1.99,
}

-- categorised, comment out anything undesireable
local availablevehicles = {
  ...
  -- sports/racer
  banshee,bullet,cheetah,comet,elegy,infernus,jester,sultan,supergt,turismo,uranus,windsor,zr350,
  hotringracer,hotringracer2,hotringracer3,

  -- motorcycles
  bf400,fcr900,freeway,nrg500,pcj600,sanchez,wayfarer,hpv1000,
  pizzaboy,faggio,
  ...
  -- small vans
  hotdog,camper,mrwhoopee,berkleysrcvan,burrito,moonbeam,newsvan,pony,rumpo,
...
--  rhino,
  ...
  -- trailers (somewhat driveable)
  baggagetraileruncovered,baggagetrailercovered,streetcleantrailer,

  -- trailers (barely driveable)
--  farmtrailer,trailer,trailertankercommando,trailerstairs,trailer1,trailer2,trailer3,

  -- airplanes
--  andromada,at400,beagle,cropduster,dodo,hydra,nevada,rustler,shamal,stuntplane,
--  skimmer -- doesn't face the correct direction
--  rcbaron,
...
--  coastguard,dinghy,jetmax,launch,marquis,predator,reefer,speeder,squalo,tropic,
  ...
  -- trains (will teleport to nearest tracks)
--  boxfreight,brownstreak,brownstreaktrailer,freight,freightflatbed,tram,
}
